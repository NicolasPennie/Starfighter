...
const $box = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#gamebox');
const $hero = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<img class="char" src="sprites/hero.png">');
...
const gun = (bulletHTML) => {
  ...
  return {
    shoot(fireRate = FIRE_RATE, bulletSpeed = BULLET_SPEED, bulletLife = BULLET_LIFE) {
      if (loaded) {
        const $bullet = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(bulletHTML);
        $box.append($bullet);
...
const enemy = (pos = [$win.width() / 2, $win.height() / 2], velo = [0, 0], dir = Math.PI / 2) => {
  const $enemy = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(ENEMY_HTML);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__gameScreen__ = __webpack_require__(5);
...
// jQuery objects
const title = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<p id="title">Starfighter</p>');
const instruction = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<p>Press SPACE to begin</p>');

// Globals
let screen;

function load() {
  __WEBPACK_IMPORTED_MODULE_1__game__["a" /* default */].$box.append(title, instruction);
  screen = setInterval(() => {
    if (__WEBPACK_IMPORTED_MODULE_2__input__["a" /* default */].down(__WEBPACK_IMPORTED_MODULE_1__game__["a" /* default */].SPACE_BAR)) {
      clearInterval(screen);
      __WEBPACK_IMPORTED_MODULE_1__game__["a" /* default */].$box.empty();
      __WEBPACK_IMPORTED_MODULE_3__gameScreen__["a" /* default */].load();
    }
  }, __WEBPACK_IMPORTED_MODULE_1__game__["a" /* default */].REFRESH);
}
...
__WEBPACK_IMPORTED_MODULE_1__game__["a" /* default */].$doc.keydown((e) => {
...
__WEBPACK_IMPORTED_MODULE_1__game__["a" /* default */].$doc.keyup((e) => {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_welcomeScreen__ = __webpack_require__(2);
// Index for Starfighter game


__WEBPACK_IMPORTED_MODULE_0__modules_welcomeScreen__["a" /* default */].load();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__enemyAI__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__welcomeScreen__ = __webpack_require__(2);
...
function playerDeath() {
  ...
  enemies = [];
  timeouts = [];
  __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].$box.empty();
  __WEBPACK_IMPORTED_MODULE_3__welcomeScreen__["a" /* default */].load();
}
...
function spawnNewEnemy(time) {
  enemies.push(__WEBPACK_IMPORTED_MODULE_2__enemyAI__["a" /* default */].spawn());
...
function userInput() {
  if (__WEBPACK_IMPORTED_MODULE_1__input__["a" /* default */].down(__WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].LEFT_ARROW)) {
    hero.rotate(__WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].ANGLE);
  }
  if (__WEBPACK_IMPORTED_MODULE_1__input__["a" /* default */].down(__WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].UP_ARROW)) {
    hero.accelerate();
  }
  if (__WEBPACK_IMPORTED_MODULE_1__input__["a" /* default */].down(__WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].RIGHT_ARROW)) {
    hero.rotate(-__WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].ANGLE);
  }
  if (__WEBPACK_IMPORTED_MODULE_1__input__["a" /* default */].tapped(__WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].SPACE_BAR)) {
    hero.shoot();
  }
}
...
function load() {
  hero = __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].hero();
  screen = setInterval(() => {
    userInput();
    __WEBPACK_IMPORTED_MODULE_2__enemyAI__["a" /* default */].run(enemies, hero);
    update();
  }, __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].REFRESH);
...
function spawn() {
  ...
  const width = __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].$win.width();
  const height = __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].$win.height();
  ...
  switch (getRandomInt(0, 4)) {
    case 0:
      // left
      pos = [-__WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].BUFFER, getRandomInt(0, height)];
    ...
    case 1:
      // top
      pos = [getRandomInt(0, width), height + __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].BUFFER];
    ...
    case 2:
      // right
      pos = [width + __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].BUFFER, getRandomInt(0, height)];
      if (pos[1] > vertMidpoint) {
    ...
    default:
      // bottom
      pos = [getRandomInt(0, width), -__WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].BUFFER];
      if (pos[0] > horzMidpoint) {
        dir = Math.PI - Math.atan(vertMidpoint / (pos[0] - horzMidpoint));
      } else {
  ...
  return __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].enemy(pos, velo, dir);
}
...
/* harmony default export */ __webpack_exports__["a"] = (enemyAI);
